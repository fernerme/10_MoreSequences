...
def run_test_make_simple_list():
    ...
    expected = [87, 88, 89, 90, 91, 92, 93, 94]
    actual = make_simple_list(87, 94)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_simple_string():
    ...
    # Test 2:
    expected = '87-88-89-90-91-92-93-94-'
    actual = make_simple_string(87, 94)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def make_simple_string(m, n):
    ...
    simple_string = ''
    for k in range(n-m+1):
        simple_string = simple_string + '{}-'.format(m+k)
...
def run_test_make_less_simple_string():
    ...
    # Test 2:
    expected = '87-88-89-90-91-92-93-94'
    actual = make_less_simple_string(87, 94)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def make_less_simple_string(m, n):
    ...
    for k in range(n-m+1):
        if k == n-m:
            less_simple_string = less_simple_string + '{}'.format(m+k)
        else:
            less_simple_string = less_simple_string + '{}-'.format(m+k)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        ...
        ulc = rg.Point(0, 0)
        ulc.x = center.x - circle.radius
        ulc.y = center.y - circle.radius
        lrc = rg.Point(0, 0)
        lrc.x = center.x + circle.radius
        lrc.y = center.y + circle.radius
        list_of_rectangles = list_of_rectangles + [rg.Rectangle(ulc, lrc)]
